...
const LevelScript level_lll_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_FAKE_WALL, fakewall_geo), 
	LOAD_MODEL_FROM_GEO(MODEL_LAVA_BULL_BLUE, lava_bull_blue_geo), 
	/* Fast64 begin persistent block [level commands] */
	/* Fast64 end persistent block [level commands] */

	AREA(1, lll_area_1),
		WARP_NODE(0x14, LEVEL_LLL, 0x02, 0x14, WARP_NO_CHECKPOINT),
		WARP_NODE(0x15, LEVEL_PSS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 0, 0, -469, 0, 90, 0, (0x0A << 16) | (191), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_BLACK_BOBOMB, 493, 570, 6543, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_BLACK_BOBOMB, 3154, 1583, 6565, 0, 0, 0, 0x00000000, bhvBobomb),
		...
		OBJECT(MODEL_NONE, 1950, -419, 858, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, 10603, -776, -5622, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
	...
	AREA(3, lll_area_3),
		...
		OBJECT(MODEL_NONE, 14755, -1124, -550, 0, 0, 0, (80 << 24) | (0x0A << 16), bhvWarp),
