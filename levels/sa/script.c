...
const LevelScript level_sa_entry[] = {
	...
	AREA(1, sa_area_1),
		...
		OBJECT(MODEL_YELLOW_COIN, 728, 720, 3740, 0, -95, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_YELLOW_COIN, -3755, 256, 2753, 0, 28, 0, 0x00000000, bhvCoinFormation),
		OBJECT(MODEL_YELLOW_COIN, 50, 555, -5262, 0, 90, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -683, 1844, 16320, 0, 0, 0, (0x0B << 16), bhvWarp),
