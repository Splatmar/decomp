...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 15919, 3700, 7238, 90, 0, -178, bob_dl_bowser_mesh_layer_1),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 13444, -185, 7175, bob_dl_pont_mesh_layer_5),
		GEO_OPEN_NODE(),
