...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 13596, 1953, 7295, 0, 90, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_LAVA_BULL, 2593, 1683, -1058, 0, -28, 0, (1 << 24), bhvlavaBull),
		OBJECT(MODEL_LAVA_BULL, 2593, 1683, 1065, 0, -128, 0, (15 << 24), bhvlavaBull),
		OBJECT(MODEL_LAVA_BULL, 4470, 1683, 1065, 0, -128, 0, (25 << 24), bhvlavaBull),
		OBJECT(MODEL_LAVA_BULL, 6413, 1683, 1065, 0, -128, 0, (35 << 24), bhvlavaBull),
		OBJECT(MODEL_LAVA_BULL, 4821, 1683, -1058, 0, -28, 0, (24 << 24), bhvlavaBull),
		OBJECT(MODEL_LAVA_BULL, 6638, 1683, -1058, 0, -28, 0, (30 << 24), bhvlavaBull),
		...
		OBJECT(MODEL_NONE, -17, 2022, 0, 0, 90, 0, (0x0A << 16) | (191), bhvInstantActiveWarp),
		...
		OBJECT(MODEL_NONE, 8474, 1903, 30, 0, 0, 0, (0x0C << 16), bhvInstantActiveWarp),
