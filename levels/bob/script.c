...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 9103, -545, 531, 0, 0, 0, (1 << 24) | (16 << 16) | (1 << 8) | (1), bhvExclamationBox),
		...
		OBJECT(MODEL_NONE, -17, 4, 0, 0, 0, 0, (10 << 16), bhvInstantActiveWarp),
		OBJECT(MODEL_TRAIN, 2613, -211, 85, 0, 0, 0, (80 << 16), bhvPlatformMooving),
		OBJECT(MODEL_NONE, 15490, -65, 7354, 0, 0, 0, (0x0B << 16), bhvWarp),
