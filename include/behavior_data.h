...
extern const BehaviorScript bhvPlatformMoovingBowser[];
...
extern const BehaviorScript bhvFlameBigger[];
...
extern const BehaviorScript bhv_big_flame_talking[];
...
extern const BehaviorScript bhvSwingingBallBottomHitbox[];
