...
enum CoinFormationFlags {
    ...
    COIN_FORMATION_FLAG_CUSTOM_SHAPE    = (1 << 3),
    COIN_FORMATION_FLAG_FLYING   = (1 << 4),
    COIN_FORMATION_FLAG_CUSTOM_OFFSET   = (1 << 5),
};
enum oBehParams2ndByteCoinFormation {
    ...
    COIN_FORMATION_BP_SHAPE_ARROW_VERTICAL  = (COIN_FORMATION_FLAG_ARROW | COIN_FORMATION_FLAG_VERTICAL),
    COIN_FORMATION_BP_SHAPE_MASK = 0x07,
    COIN_FORMATION_BP_SHAPE_CUSTOM          = (COIN_FORMATION_FLAG_CUSTOM_SHAPE),
...
enum ExclamationBoxContentsList { // oBehParams2ndByte, ExclamationBoxContents->id
    ...
    EXCLAMATION_BOX_DAMAGE_BOWSER,
    EXCLAMATION_BOX_DELETE_FLAME,
};
