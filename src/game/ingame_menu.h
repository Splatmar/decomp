...
enum DialogSpecialChars {
    ...
    DIALOG_CHAR_LOWER_A_AIGUE        = 0x63, // 'a' aigue
    ...
    DIALOG_CHAR_UPPER_A_AIGUE        = 0x67, // 'A' acute
    ...
    DIALOG_CHAR_LOWER_U_AIGUE        = 0x83, // 'u' AIGUE
    ...
    DIALOG_CHAR_UPPER_U_AIGUE        = 0x87, // 'U' aigue
    ...
    DIALOG_CHAR_LOWER_O_AIGUE        = 0x93, // 'o' aigue
    ...
    DIALOG_CHAR_UPPER_O_AIGUE        = 0x97, // 'O' aigue
